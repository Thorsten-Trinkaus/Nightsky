...
class Star extends CelestialBody {
    ...
    constructor(model, texture, scale, color, alpha, index) {
        ...
        // only lightsource in the current solar system.
     ...
     * @param {![number, number, number]} rotObject - rotation around 
     *      x,y,z-axis in object-space (in dec)
     * @param {![number, number, number]} rotRoot - rotation around 
     *      x,y,z-axis in the object-space of this star (in dec)
     ...
     * @param {!number} speed - multiplicator for the movement speed
     */
    update(time, speed) {
        for (let i = 0; i < this.objects.length; i++) {
...
class OrbitingObject extends CelestialBody {
     ...
     *      x,y,z-axis in object-space (in dec)
     * @param {![number, number, number]} rotRoot - rotation around 
     *      x,y,z-axis in root-object-space (in dec)
     * @param {!number} rotSpeed - speed at which this object 
     *      rotates around itself 
     * @param {!number} orbitSpeed - speed at which this object
     *      orbits around its root
    ...
    constructor(
        ...
        quat.fromEuler(
            this.rotationObject, rotObject[0], rotObject[1], rotObject[2]
        );
        ...
        // This can be used to visualise the orbit of this object.
     ...
     * this.position is relativ to the position of the root-object.
    ...
    getRootPosition() {
        ...
        // root-object is relativ to its root. In this case it is necessary 
     ...
     *      positiv. This parameter is optional and a base value of 100 is used
    ...
    addDynamicOrbit(steps = 100) {
        ...
        for (let phi = 0; phi < 2 * Math.PI; phi += 2 * Math.PI / steps) {
            ...
            // Create a placeholder at the position. The placehoder will 
